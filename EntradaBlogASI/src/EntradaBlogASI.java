...
public class EntradaBlogASI {
	...
	*/
	...
	public EntradaBlogASI(int id,String autor,String texto)throws IllegalArgumentException{
	...
	public static void main(String[] args) {
                //Modificar.
		EntradaBlogASI e1=new EntradaBlogASI (3,"ana","Últimas noticias, está disponible BixBy 2.0");
